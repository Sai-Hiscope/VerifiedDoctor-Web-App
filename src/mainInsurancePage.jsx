   ...
   <MainHeader/>
      <div className="mainInsurance-container">
        ...
        <div className="mainInsurance-div2" >
            <ul>
                <li> <h5>Regular Insurance</h5>
                <div className="mainInsurance-div2-div-img" > <img src={RegularInsuranceImg} alt="RegularInsuranceImg" /></div>
                <h4>"Secure your future today, for peace of mind tomorrow."</h4>
                <div className="mainInsurance-div2-div-p"><p>Regular insurance ensures you’re covered against unexpected events, giving you financial security for whatever comes your way <a href="">Read More...</a></p>
                <button className="mainInsurance-div2-div2-btn" onClick={handleInsurnaceType}>CLICK HERE <br />TO APPLY</button>
                </div>
                </li>
                <li>
                    <h5>Micro Insurance</h5>
                    <div className="mainInsurance-div2-div-img"> <img src={MicroInsuranceImg} alt="MicroInsuranceImg" /> </div>
                    <h4>"A little insurance goes a long way—start small, feel secure."</h4>
                    <div className="mainInsurance-div2-div-p"><p>Micro insurance offers small, affordable plans that provide important protection without breaking the bank.  <a href="">Read More...</a></p>
                <button className="mainInsurance-div2-div2-btn" onClick={handleInsurnaceType}>CLICK HERE <br />TO APPLY</button>
                </div>
                </li>
            </ul>
