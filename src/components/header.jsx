          ...
          <nav className="nav-container">
            ...
            <div className="nav-menu">
              <div className="nav-links">
                ...
                <Link to="/doctorVerificationpage" className="nav-link">
                  Verify a Doctor
                </Link>
                ...
                <Link
                  to="https://v-commerce-in.netlify.app/"
                  className="nav-link"
                >
                  Home Delivery Medicines
                </Link>
                <Link to="/mainInsurancePage" className="nav-link">
                  Insurance
                </Link>
            ...
            <button className="login-button-header" onClick={LoginButtonClick}>
              Login/Signup
            </button>
          </nav>
        </section>
